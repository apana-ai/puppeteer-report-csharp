...
Then bump version in .csproj and run: `dotnet pack -c Release` and `dotnet nuget push "./src/puppeteer-report/bin/Release/puppeteer-report.3.0.4-fork.nupkg" --source github` (change the new version). That's it
